...
- If the resource points during special weathers is available for the current job of the character, the module will repeat the process that gathering these points, leaving the duty and re-joining.
